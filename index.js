...
prompt([
    {
        ...
        choices: [
            ...
            {
                name: "View Total Uttilized Budget By Department",
                ...
                .then(res => {
                    ...
                    .then(([rows]) => {
                        ...
                        prompt ([
                            ...
                            .then(res => db.updatEmployeeRole(employeeId, res.roleId))
